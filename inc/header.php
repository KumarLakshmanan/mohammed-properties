...
<header class="main-header header-style-one">
        ...
        <div class="container">
            <div class="outer-box">
                <div class="header-left">
                    <div class="logo">
                        <a href="#"><img style="height:50px" src="images/logo.png" alt="Awesome Logo" title></a>
                    </div>
                </div>
                        ...
                        <nav class="main-menu style1 navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li><a href="<?= $webBaseUrl ?>">Home</a></li>
                                    <li class="dropdown">
                                        <a href="#">Services</a>
                                        <ul>
                                            <li><a href="<?= $webBaseUrl ?>seo.php">SEO</a></li>
                                            <li><a href="<?= $webBaseUrl ?>digital-marketing.php">Digital Marketing</a></li>
                                            <li><a href="<?= $webBaseUrl ?>software-development.php">Software Development</a></li>
                                            <li><a href="<?= $webBaseUrl ?>real-estate.php">Real Estate</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="<?= $webBaseUrl ?>about.php">About us</a></li>
                                    <li><a href="<?= $webBaseUrl ?>contact.php">Contact</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
        ...
        <div class="container">
            <div class="clearfix">
                <div class="logo float-left">
                    <a href="#" class="img-responsive"><img style="height:75px" src="images/sticky-logo.png" alt title></a>
                </div>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="#"><img style="height:50px" src="images/mobilemenu-logo.png" alt title></a></div>
